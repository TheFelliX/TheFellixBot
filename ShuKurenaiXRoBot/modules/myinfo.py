...
from ShuKurenaiXRoBot import dispatcher
...
async def proboyx(event):
    ...
    on = await bot.send_file(
        event.chat_id,
        file=file2,
        caption=f"➣ **Hey** {smexy} **I'm Anie**\n➣ **Powered By @The_Godfather_Network**\n➣ **Click The Button Below To Get Your Info! In Anie**",
