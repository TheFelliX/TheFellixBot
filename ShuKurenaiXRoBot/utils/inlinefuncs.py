...
from ShuKurenaiXRoBot import pbot as app 
from ShuKurenaiXRoBot import arq
from ShuKurenaiXRoBot.services.keyboard import Ikb
from ShuKurenaiXRoBot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from ShuKurenaiXRoBot.services.tasks import _get_tasks_text, all_tasks, rm_task
from ShuKurenaiXRoBot.services.types import InlineQueryResultCachedDocument
from ShuKurenaiXRoBot.modules.info import get_chat_info, get_user_info
from ShuKurenaiXRoBot.modules.music import download_youtube_audio
from ShuKurenaiXRoBot.utils.functions import test_speedtest
from ShuKurenaiXRoBot.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/23bb5d70ec22993f22a0e.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/TheFellixBot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[TheFellixBot 🔥](https://telegra.ph/file/23bb5d70ec22993f22a0e.jpg):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [Owner](t.me/MrNitric) 
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def music_inline_func(answers, query):
    ...
    group_invite = "https://t.me/The_Friend_Circle"
    try:
        messages = [
            m
