...
def shukurenai_about_callback(update, context):
    ...
    if query.data == "shukurenai_":
        query.message.edit_text(
            text="๏ I'm *𝐓𝐡𝐞 𝐅𝐞𝐥𝐥𝐢𝐗*, a powerful group management bot built to help you manage your group easily."
        ...
        query.message.edit_text(
            text="*๏ FelliX support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on FelliX.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
        ...
        query.message.edit_text(
            text=f"๏ Credis for FelliX Bot\n"
            "\nHere Developers Making And Give Inspiration For Made The FelliX",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[Fire 🔥](https://telegra.ph/file/af926eb734b759107de96.jpg)", parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                  [                  
                       InlineKeyboardButton(
